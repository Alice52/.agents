...
Use the current request as input. Read [shared customizations](../../ai-share-config/workflows/speckit/customizations.md), then [the implement workflow](../../ai-share-config/workflows/speckit/implement.md).
