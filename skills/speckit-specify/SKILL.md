...
Use the current request as input. Read [shared customizations](references/speckit/customizations.md), then [the specify workflow](references/speckit/specify.md).
