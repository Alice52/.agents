...
Use the current request as input. Read [shared customizations](references/speckit/customizations.md), then [the analyze workflow](references/speckit/analyze.md).
