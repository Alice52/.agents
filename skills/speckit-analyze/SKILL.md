...
description: Execute the Spec Kit analyze workflow with current core behavior and shared Chinese customizations. Use when the user requests the Spec Kit analyze phase.
---

Use the current request as input. Read [shared customizations](../../ai-share-config/workflows/speckit/customizations.md), then [the analyze workflow](../../ai-share-config/workflows/speckit/analyze.md).
