...
Use the current request as input. Read [shared customizations](references/speckit/customizations.md), then [the constitution workflow](references/speckit/constitution.md).
