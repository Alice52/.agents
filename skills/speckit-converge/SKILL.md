...
Use the current request as input. Read [shared customizations](references/speckit/customizations.md), then [the converge workflow](references/speckit/converge.md).
