...
description: Execute the Spec Kit converge workflow with current core behavior and shared Chinese customizations. Use when the user requests the Spec Kit converge phase.
---

Use the current request as input. Read [shared customizations](../../ai-share-config/workflows/speckit/customizations.md), then [the converge workflow](../../ai-share-config/workflows/speckit/converge.md).
