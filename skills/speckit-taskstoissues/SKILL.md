...
description: Execute the Spec Kit taskstoissues workflow with current core behavior and shared Chinese customizations. Use when the user requests the Spec Kit taskstoissues phase.
---

Use the current request as input. Read [shared customizations](../../ai-share-config/workflows/speckit/customizations.md), then [the taskstoissues workflow](../../ai-share-config/workflows/speckit/taskstoissues.md).
