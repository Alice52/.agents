---
name: speckit-tasks
description: Execute the Spec Kit tasks workflow with current core behavior and shared Chinese customizations. Use when the user requests the Spec Kit tasks phase.
---

Use the current request as input. Read [shared customizations](../../ai-share-config/workflows/speckit/customizations.md), then [the tasks workflow](../../ai-share-config/workflows/speckit/tasks.md).
