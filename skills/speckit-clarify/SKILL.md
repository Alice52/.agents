...
Use the current request as input. Read [shared customizations](references/speckit/customizations.md), then [the clarify workflow](references/speckit/clarify.md).
